################################################
# make a gene count file including all samples 
################################################
...
#########################################
# convert athe gene count table to .csv
#########################################

cat genecount | tr -s '[:blank:]' ',' > genecount.csv

# remove trailing "quant.sf" text from each sample (make it from "T_1_quant.sf" -> "T_1")
